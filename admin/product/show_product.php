							...
							<tbody>
								...
								?>
										<tr>
											...
											<td><a href="../product/edit_product.php?id=<?= $product['id'] ?>"><img src="/admin/images/icons8-edit.gif" /></a></td>
											<td><a href="javascript:alert(<?= $product['id'] ?>)"><img src="https://img.icons8.com/ios-glyphs/30/000000/filled-trash.png" /></a>
											</td>
										</tr>
								<?php
									} else {
