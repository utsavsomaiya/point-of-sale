<?php
    ...
    $salesDetails = $pdo->prepare("SELECT COUNT(*) as `total_sales`, SUM(`total`) as `sales_total`, SUM(`price_discount`) as `total_discount`, SUM(`total_tax`) as `total_tax`, COUNT(`gift_discount`) as `gift_discount` FROM `sales`");
                            ...
                            <div class="row">
                                <div class="col-sm-7">
                                    <div class="statistics-details d-flex align-items-center justify-content-between">
                                        ...
                                        <div>
                                            <p class="statistics-title">Total Gift offered</p>
                                            <h3 class="rate-percentage">
